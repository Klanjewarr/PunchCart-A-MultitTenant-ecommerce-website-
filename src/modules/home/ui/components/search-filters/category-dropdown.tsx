        ...
        <div className="relative" ref={dropdownRef} onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}  >
            ...
            <div className="relative">
                ...
                {category.subcategories && category.subcategories.length > 0 && (
                    <div
                        className={cn( "opacity-0 absolute -bottom-3 w-0 h-0 left-1/2 -translate-x-1/2 transition-all duration-200",
                            // When closed: arrow points down
                            !isOpen && "border-l-[10px] border-l-transparent border-r-[10px] border-r-transparent border-t-[10px] border-t-black",
                            // When open: arrow points up
                            isOpen && "opacity-100 border-l-[10px] border-l-transparent border-r-[10px] border-r-transparent border-b-[10px] border-b-black"
                        )}
                    />
                )}
            </div>
