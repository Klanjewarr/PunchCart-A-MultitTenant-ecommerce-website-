...
export interface Tenant {
  id: string;
  /**
   * This is the name of the store(e.g. Kanchan's Store)
   */
  name: string;
  /**
   * This is the subdomain of the store(e.g. [slug].punchcart.com)
   */
  slug: string;
...
export interface Order {
  ...
  /**
   * Stripe account session associated with the order
   */
